...
test_words = ["playing", "living", "sensitive", "informative"]
for test_word in test_words:
    stemmed_word = p.step_1a(test_word)
    stemmed_word = p.step_1b(stemmed_word)
    stemmed_word = p.step_1c(stemmed_word)
    stemmed_word = p.step_2(stemmed_word)
    stemmed_word = p.step_3(stemmed_word)
    stemmed_word = p.step_4(stemmed_word)
    stemmed_word = p.step_5a(stemmed_word)
    stemmed_word = p.step_5b(stemmed_word)
